...
export default function RagPipeline({doc,vectors,trace,busy,progress,mode,aiConfigured,studyTool}){
  ...
  const stages=[
    ...
    {title:'Index',description:'Session-memory passages and optional vectors',ms:timings.indexMs,status:doc?(doc.needsReview?'Awaiting image review':doc.chunks.length?'Ready · browser session index':'No readable passages'):'Waiting for document'},
